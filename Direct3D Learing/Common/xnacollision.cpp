...
VOID ComputeBoundingOrientedBoxFromPoints( OrientedBox* pOut, UINT Count, const XMFLOAT3* pPoints, UINT Stride )
{
   ...
   assert( pPoints );
    ...
    for( UINT i = 0; i < Count; i++ )
    {
		...
		XMVECTOR XXY = DirectX::XMVectorPermute(Point, Point, PermuteXXY.i[0], PermuteXXY.i[1], PermuteXXY.i[2], PermuteXXY.i[3]);
        XMVECTOR YZZ = XMVectorPermute( Point, Point, PermuteYZZ.i[0], PermuteYZZ.i[1], PermuteYZZ.i[2], PermuteYZZ.i[3]);
...
BOOL IntersectTriangleAxisAlignedBox( FXMVECTOR V0, FXMVECTOR V1, FXMVECTOR V2, const AxisAlignedBox* pVolume )
{
   ...
   assert( !XMVector3Equal( Normal, Zero ) );
    ...
    Axis = XMVectorPermute( e0, -e0, Permute0W1Z0Y0X.i[0], Permute0W1Z0Y0X.i[1], Permute0W1Z0Y0X.i[2], Permute0W1Z0Y0X.i[3]);
    ...
    Axis = XMVectorPermute( e1, -e1, Permute0W1Z0Y0X.i[0], Permute0W1Z0Y0X.i[1], Permute0W1Z0Y0X.i[2], Permute0W1Z0Y0X.i[3]);
    p0 = XMVector3Dot( TV0, Axis );
    ...
    Axis = XMVectorPermute( e2, -e2, Permute0W1Z0Y0X.i[0], Permute0W1Z0Y0X.i[1], Permute0W1Z0Y0X.i[2], Permute0W1Z0Y0X.i[3]);
    p0 = XMVector3Dot( TV0, Axis );
    p1 = XMVector3Dot( TV1, Axis );
    ...
    Axis = XMVectorPermute( e0, -e0, Permute0Z0W1X0Y.i[0], Permute0Z0W1X0Y.i[1], Permute0Z0W1X0Y.i[2], Permute0Z0W1X0Y.i[3]);
    p0 = XMVector3Dot( TV0, Axis );
    // p1 = XMVector3Dot( V1, Axis ); // p1 = p0;
    p2 = XMVector3Dot( TV2, Axis );
    Min = XMVectorMin( p0, p2 );
    ...
    Axis = XMVectorPermute( e1, -e1, Permute0Z0W1X0Y.i[0], Permute0Z0W1X0Y.i[1], Permute0Z0W1X0Y.i[2], Permute0Z0W1X0Y.i[3]);
    p0 = XMVector3Dot( TV0, Axis );
    p1 = XMVector3Dot( TV1, Axis );
    // p2 = XMVector3Dot( V2, Axis ); // p2 = p1;
    Min = XMVectorMin( p0, p1 );
    ...
    Axis = XMVectorPermute( e2, -e2, Permute0Z0W1X0Y.i[0], Permute0Z0W1X0Y.i[1], Permute0Z0W1X0Y.i[2], Permute0Z0W1X0Y.i[3]);
    p0 = XMVector3Dot( TV0, Axis );
    p1 = XMVector3Dot( TV1, Axis );
    // p2 = XMVector3Dot( V2, Axis ); // p2 = p0;
    Min = XMVectorMin( p0, p1 );
    ...
    Axis = XMVectorPermute( e0, -e0, Permute1Y0X0W0Z.i[0], Permute1Y0X0W0Z.i[1], Permute1Y0X0W0Z.i[2], Permute1Y0X0W0Z.i[3]);
    p0 = XMVector3Dot( TV0, Axis );
    // p1 = XMVector3Dot( V1, Axis ); // p1 = p0;
    p2 = XMVector3Dot( TV2, Axis );
    Min = XMVectorMin( p0, p2 );
    ...
    Axis = XMVectorPermute( e1, -e1, Permute1Y0X0W0Z.i[0], Permute1Y0X0W0Z.i[1], Permute1Y0X0W0Z.i[2], Permute1Y0X0W0Z.i[3]);
    p0 = XMVector3Dot( TV0, Axis );
    p1 = XMVector3Dot( TV1, Axis );
    // p2 = XMVector3Dot( V2, Axis ); // p2 = p1;
    Min = XMVectorMin( p0, p1 );
    ...
    Axis = XMVectorPermute( e2, -e2, Permute1Y0X0W0Z.i[0], Permute1Y0X0W0Z.i[1], Permute1Y0X0W0Z.i[2], Permute1Y0X0W0Z.i[3]);
    p0 = XMVector3Dot( TV0, Axis );
    p1 = XMVector3Dot( TV1, Axis );
    // p2 = XMVector3Dot( V2, Axis ); // p2 = p0;
    Min = XMVectorMin( p0, p1 );
...
BOOL IntersectOrientedBoxOrientedBox( const OrientedBox* pVolumeA, const OrientedBox* pVolumeB )
{
   ...
   assert( XMQuaternionIsUnit( B_quat ) );
    ...
    d = XMVector3Dot( t, XMVectorPermute( RX0, -RX0, Permute0W1Z0Y0X.i[0], Permute0W1Z0Y0X.i[1], Permute0W1Z0Y0X.i[2], Permute0W1Z0Y0X.i[3]) );
    d_A = XMVector3Dot( h_A, XMVectorPermute( ARX0, ARX0, PermuteWZYX.i[0], PermuteWZYX.i[1], PermuteWZYX.i[2], PermuteWZYX.i[3]) );
    d_B = XMVector3Dot( h_B, XMVectorPermute( AR0X, AR0X, PermuteWZYX.i[0], PermuteWZYX.i[1], PermuteWZYX.i[2], PermuteWZYX.i[3]) );
    NoIntersection = XMVectorOrInt( NoIntersection, 
                                    XMVectorGreater( XMVectorAbs(d), XMVectorAdd( d_A, d_B ) ) );
    ...
    d = XMVector3Dot( t, XMVectorPermute( RX1, -RX1, Permute0W1Z0Y0X.i[0], Permute0W1Z0Y0X.i[1], Permute0W1Z0Y0X.i[2], Permute0W1Z0Y0X.i[3]) );
    d_A = XMVector3Dot( h_A, XMVectorPermute( ARX1, ARX1, PermuteWZYX.i[0], PermuteWZYX.i[1], PermuteWZYX.i[2], PermuteWZYX.i[3]) );
    d_B = XMVector3Dot( h_B, XMVectorPermute( AR0X, AR0X, PermuteZWXY.i[0], PermuteZWXY.i[1], PermuteZWXY.i[2], PermuteZWXY.i[3]) );
    NoIntersection = XMVectorOrInt( NoIntersection, 
                                    XMVectorGreater( XMVectorAbs(d), XMVectorAdd( d_A, d_B ) ) );
    ...
    d = XMVector3Dot( t, XMVectorPermute( RX2, -RX2, Permute0W1Z0Y0X.i[0], Permute0W1Z0Y0X.i[1], Permute0W1Z0Y0X.i[2], Permute0W1Z0Y0X.i[3]) );
    d_A = XMVector3Dot( h_A, XMVectorPermute( ARX2, ARX2, PermuteWZYX.i[0], PermuteWZYX.i[1], PermuteWZYX.i[2], PermuteWZYX.i[3]) );
    d_B = XMVector3Dot( h_B, XMVectorPermute( AR0X, AR0X, PermuteYXWZ.i[0], PermuteYXWZ.i[1], PermuteYXWZ.i[2], PermuteYXWZ.i[3]) );
    NoIntersection = XMVectorOrInt( NoIntersection, 
                                    XMVectorGreater( XMVectorAbs(d), XMVectorAdd( d_A, d_B ) ) );
    ...
    d = XMVector3Dot( t, XMVectorPermute( RX0, -RX0, Permute0Z0W1X0Y.i[0], Permute0Z0W1X0Y.i[1], Permute0Z0W1X0Y.i[2], Permute0Z0W1X0Y.i[3]) );
    d_A = XMVector3Dot( h_A, XMVectorPermute( ARX0, ARX0, PermuteZWXY.i[0], PermuteZWXY.i[1], PermuteZWXY.i[2], PermuteZWXY.i[3]) );
    d_B = XMVector3Dot( h_B, XMVectorPermute( AR1X, AR1X, PermuteWZYX.i[0], PermuteWZYX.i[1], PermuteWZYX.i[2], PermuteWZYX.i[3]) );
    NoIntersection = XMVectorOrInt( NoIntersection, 
                                    XMVectorGreater( XMVectorAbs(d), XMVectorAdd( d_A, d_B ) ) );
    ...
    d = XMVector3Dot( t, XMVectorPermute( RX1, -RX1, Permute0Z0W1X0Y.i[0], Permute0Z0W1X0Y.i[1], Permute0Z0W1X0Y.i[2], Permute0Z0W1X0Y.i[3]));
    d_A = XMVector3Dot( h_A, XMVectorPermute( ARX1, ARX1, PermuteZWXY.i[0], PermuteZWXY.i[1], PermuteZWXY.i[2], PermuteZWXY.i[3]) );
    d_B = XMVector3Dot( h_B, XMVectorPermute( AR1X, AR1X, PermuteZWXY.i[0], PermuteZWXY.i[1], PermuteZWXY.i[2], PermuteZWXY.i[3]) );
    NoIntersection = XMVectorOrInt( NoIntersection, 
                                    XMVectorGreater( XMVectorAbs(d), XMVectorAdd( d_A, d_B ) ) );
    ...
    d = XMVector3Dot( t, XMVectorPermute( RX2, -RX2, Permute0Z0W1X0Y.i[0], Permute0Z0W1X0Y.i[1], Permute0Z0W1X0Y.i[2], Permute0Z0W1X0Y.i[3]));
    d_A = XMVector3Dot( h_A, XMVectorPermute( ARX2, ARX2, PermuteZWXY.i[0], PermuteZWXY.i[1], PermuteZWXY.i[2], PermuteZWXY.i[3]) );
    d_B = XMVector3Dot( h_B, XMVectorPermute( AR1X, AR1X, PermuteYXWZ.i[0], PermuteYXWZ.i[1], PermuteYXWZ.i[2], PermuteYXWZ.i[3]) );
    NoIntersection = XMVectorOrInt( NoIntersection, 
                                    XMVectorGreater( XMVectorAbs(d), XMVectorAdd( d_A, d_B ) ) );
    ...
    d = XMVector3Dot( t, XMVectorPermute( RX0, -RX0, Permute0Z0W1X0Y.i[0], Permute0Z0W1X0Y.i[1], Permute0Z0W1X0Y.i[2], Permute0Z0W1X0Y.i[3]));
    d_A = XMVector3Dot( h_A, XMVectorPermute( ARX0, ARX0, PermuteYXWZ.i[0], PermuteYXWZ.i[1], PermuteYXWZ.i[2], PermuteYXWZ.i[3]) );
    d_B = XMVector3Dot( h_B, XMVectorPermute( AR2X, AR2X, PermuteWZYX.i[0], PermuteWZYX.i[1], PermuteWZYX.i[2], PermuteWZYX.i[3]) );
    NoIntersection = XMVectorOrInt( NoIntersection, 
                                    XMVectorGreater( XMVectorAbs(d), XMVectorAdd( d_A, d_B ) ) );
    ...
    d = XMVector3Dot( t, XMVectorPermute( RX1, -RX1, Permute0Z0W1X0Y.i[0], Permute0Z0W1X0Y.i[1], Permute0Z0W1X0Y.i[2], Permute0Z0W1X0Y.i[3]));
    d_A = XMVector3Dot( h_A, XMVectorPermute( ARX1, ARX1, PermuteYXWZ.i[0], PermuteYXWZ.i[1], PermuteYXWZ.i[2], PermuteYXWZ.i[3]) );
    d_B = XMVector3Dot( h_B, XMVectorPermute( AR2X, AR2X, PermuteZWXY.i[0], PermuteZWXY.i[1], PermuteZWXY.i[2], PermuteZWXY.i[3]) );
    NoIntersection = XMVectorOrInt( NoIntersection, 
                                    XMVectorGreater( XMVectorAbs(d), XMVectorAdd( d_A, d_B ) ) );
    ...
    d = XMVector3Dot( t, XMVectorPermute( RX2, -RX2, Permute0Z0W1X0Y.i[0], Permute0Z0W1X0Y.i[1], Permute0Z0W1X0Y.i[2], Permute0Z0W1X0Y.i[3]));
    d_A = XMVector3Dot( h_A, XMVectorPermute( ARX2, ARX2, PermuteYXWZ.i[0], PermuteYXWZ.i[1], PermuteYXWZ.i[2], PermuteYXWZ.i[3]) );
    d_B = XMVector3Dot( h_B, XMVectorPermute( AR2X, AR2X, PermuteYXWZ.i[0], PermuteYXWZ.i[1], PermuteYXWZ.i[2], PermuteYXWZ.i[3]) );
    NoIntersection = XMVectorOrInt( NoIntersection, 
                                    XMVectorGreater( XMVectorAbs(d), XMVectorAdd( d_A, d_B ) ) );
