...
bool ParticlesApp::Init()
{
	...
	HR(CreateDDSTextureFromFile(md3dDevice, L"Textures\\flare0.dds", 0, &mFlareTexSRV, 0));
	...
	HR(CreateDDSTextureFromFile(md3dDevice, L"Textures\\raindrop.dds", 0, &mRainTexSRV, 0));
