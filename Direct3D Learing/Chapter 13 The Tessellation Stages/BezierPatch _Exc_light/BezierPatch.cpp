  ...
  mEyePosW(0.0f, 0.0f, 0.0f), mTheta(1.3f*MathHelper::Pi), mPhi(0.4f*MathHelper::Pi), mRadius(80.0f)
{
	...
	mSurfaceMat.Ambient = XMFLOAT4(0.5f, 0.5f, 0.5f, 1.0f);
	mSurfaceMat.Diffuse = XMFLOAT4(1.0f, 1.0f, 1.0f, 1.0f);
	mSurfaceMat.Specular = XMFLOAT4(0.2f, 0.2f, 0.2f, 16.0f);
}
...
void BasicTessellation::DrawScene()
{
	...
	Effects::BezierTessellationFX->SetDirLights(mDirLights);
	Effects::BezierTessellationFX->SetMaterial(mSurfaceMat);
